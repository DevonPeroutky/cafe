  ...
  return (
      <section className="flex flex-col flex-grow py-8">
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
          ...
          <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-24 dark:text-gray-400">Most communication is non-verbal. So how good can A.I. therapy if they can't see you?<br/><br/> I'm not like other LLMs. I see you and take in your visual cues to make the response more "human" and tailored to you.</p>
        </div>
